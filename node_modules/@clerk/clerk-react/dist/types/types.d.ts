import type { Clerk, ClerkOptions, ClientResource, DomainOrProxyUrl, LoadedClerk, MultiDomainAndOrProxy, PublishableKeyOrFrontendApi, SDKMetadata, SessionResource, SignInRedirectOptions, SignUpRedirectOptions, UserResource } from '@clerk/types';
...
} & PublishableKeyOrFrontendApi & MultiDomainAndOrProxy;
...
export type WithUserProp<T = unknown> = T & {
    user: UserResource;
};
export type WithSessionProp<T = unknown> = T & {
...
export type ClerkProp = BrowserClerkConstructor | BrowserClerk | HeadlessBrowserClerk | HeadlessBrowserClerkConstrutor | undefined | null;
type ButtonProps = {
